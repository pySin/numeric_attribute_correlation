...
class m_to_class:
    ...
    def yes_no_similarity(self):
        ...
        yes_no = '''
            CREATE TABLE IF NOT EXISTS %s_cs(
    ...
    def yes_no_insert(self, main_column):
        ...
        # the lowest average of the secondary protein. 2 should be smaller
        # than 3 and 3 smaller than 4. In this way the main and the secondary
        # proteins synchronize on there concentration levels.
...
# Functions call.
def call_functions(source_table):
    # Change the database and table names below with the ones you chose.
    meas_to_class = m_to_class(source_table)
...
if __name__ == '__main__':
    call_functions('test_correlation.protein_measures')
